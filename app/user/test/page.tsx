                                ...
                                {unlockedClasses.length === 0 ? (
                                    ...
                                    <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6">
                                        <div className="flex items-start gap-3 mb-4">
                                            ...
                                            <div>
                                                <h3 className="text-sm font-black text-white mb-1">No Classes Unlocked Yet</h3>
                                                <p className="text-amber-200/80 text-xs leading-relaxed">
                                                    You don&apos;t have access to any class yet. Contact your teacher on WhatsApp or use a coupon code to unlock a class.
                                                </p>
                                            </div>
                                        </div>
                                        {WHATSAPP_GROUP_URL && (
                                            <a
                                                ...
                                                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-sm py-3 transition-colors shadow-lg shadow-[#25D366]/20"
                                            >
                                                ...
                                                Contact on WhatsApp to Get Access
                                            </a>
                                        )}
                                    </div>
                                ) : (
                                    <select
                                        value={selectedClass}
                                        onChange={(e) => { setSelectedClass(e.target.value); setError(null); setSuccessMsg(null); }}
